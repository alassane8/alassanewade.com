    ...
    <header>
      <div id="home" className = "mx-auto bg-gray-800 max-w-6xl">
        <div className="grid place-items-center">
            ...
            <button class="border-white border-t-4 border-l-4 border-r-4 border-b-4 bg-gray-800 text-2xl text-white font-bold px-4 py-4 rounded hover:scale-110 hover:text-blue-300 hover:border-blue-300">
